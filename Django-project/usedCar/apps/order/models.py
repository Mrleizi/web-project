...
#     suser = models.ForeignKey(User, on_delete=models.CASCADE, verbose_name='买家')
...
class Orders(models.Model):
    sale_user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='suser', verbose_name='卖家')
    buy_user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='buser', verbose_name='买家')
    car = models.ForeignKey(Carinfo, null=True, on_delete=models.CASCADE, related_name='car', verbose_name='车辆')
