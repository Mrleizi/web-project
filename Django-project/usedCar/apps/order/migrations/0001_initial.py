# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2019-03-23 10:43
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('buy_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='buser', to='user.User', verbose_name='买家')),
                ('sale_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='suser', to='user.User', verbose_name='卖家')),
            ],
            options={
                'verbose_name': '订单表',
