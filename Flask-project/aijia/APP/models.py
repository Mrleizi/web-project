...
class User(BaseModel, db.Model):
    ...
    houses = db.relationship('House', backref='APP')  # 房屋
    orders = db.relationship('Order', backref='APP')  # 订单
...
class House(BaseModel, db.Model):
    ...
    def to_dict(self):
        return {
            ...
            # 'avatar':current_app.config['QINIU_URL']+self.APP.avatar if self.APP.avatar else '',
